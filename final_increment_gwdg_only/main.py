...
#   • Update: Reranking entfernt, Hybrid‑Retriever wird direkt verwendet
# ============================================================================
...
# ----------------------------------------------------------------------------
# 4) Retriever (ohne Reranking)
# ----------------------------------------------------------------------------

# Reranking (RankLLM) wurde entfernt. Das System nutzt nun direkt den Hybrid‑Retriever.
